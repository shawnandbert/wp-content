...
function sugarspice_posted_on() {
	...
	$time_string = '<span class="posted-on"><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date published" datetime="%3$s">%4$s</time></a></span>';
    ...
    $author_string = '<span class="byline"> %1$s <span class="author vcard"><a href="%2$s" title="%3$s" rel="author">%4$s</a></span></span>';
